...
class PersonFactory():
    ...
    def create(cls, data_source: DataSource, household: dict, schools: dict[str, list[str]], province: str, is_adult_required=False) -> Person:
        ...
        work = cls.get_work_info(data_source, age, sex)
        ...
        person = Person(age=age, age_group=age_group, sex=sex, work=work, study=study, study_details=study_details, school=school,
